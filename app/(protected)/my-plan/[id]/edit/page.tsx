  ...
  return (
    ...
    <div className="max-w-[var(--reading-w)] mx-auto">
      <MyPlanNewForm
        ...
        //   폼은 편집 중인 라이브 합계와 비교하지 않는다 — 고쳤다 되돌릴 때 깜빡이고,
        //   저장 없이 나갔다 오면 화면이 방금 한 말을 뒤집는다(정본: lib/plan/cost-snapshot.ts).
        // 0595: 총액 대조 → **이벤트 기록**(costEdited). 총액은 상쇄 수정을 못 잡았다.
        //   판정은 저장 액션이 하고 여기선 읽기만 한다 — 읽기 상세와 같은 소스.
        sourcePlanId={plan.sourcePlanId}
        isCostUnchanged={!plan.costEdited}
      />
    </div>
  );
}
