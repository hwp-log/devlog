...
// 0559: 구 문구 "공개하면 비용이 비중·구간으로 가공되어 표시됩니다"는 0492(금액 공개)·
//   0558(band 폐기)로 사실이 아니게 됨 — 새 규칙(0557: 비공개 = 글 자체를 가림)의 문구로 교체.
//   한 줄로 양 상태 설명 가능해 상태별 분기 없음.
export function PlanOwnerNotice() {
  return (
