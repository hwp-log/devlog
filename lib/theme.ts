...
export const theme = {
  ...
  light: {
    ...
    // amber-700 = bg(#ffffff) 대비 5.01:1 — 13px 소형 텍스트 AA(4.5) 충족.
    // amber-600(#d97706, 3.19:1)에서 한 단 내린 값이다. 라이트 danger가 3.08:1 미달을
    // 수용한 것(0477)과 갈리는 건 용도 차이 — 저빈도 파괴 버튼은 색·아이콘·위치로도
    // 식별되지만 이건 **읽으라고 쓰는 문장**이라 대비를 지킨다.
  ...
  dark: {
    ...
    // amber-500 = bg(#151718) 대비 8.46:1. amber-400(#fbbf24)은 accent(#f0c040, 별점 전용)와
